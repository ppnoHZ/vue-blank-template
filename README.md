...
- `@qes/ui`: a stub component & utility library shared by both `web` and `docs` applications
- `@qes/eslint-config`: shared `eslint` configurations
- `@qes/typescript-config`: `tsconfig.json`s used throughout the monorepo
